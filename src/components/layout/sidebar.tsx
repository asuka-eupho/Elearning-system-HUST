...
const Sidebar = () => {
    ...
    return (
        <div className='hidden p-4 border-r border-r-gray-300 dark:border-opacity-10 bg-white
         dark:bg-grayDarker lg:flex flex-col fixed top-0 left-0 bottom-0 w-[300px]'>
